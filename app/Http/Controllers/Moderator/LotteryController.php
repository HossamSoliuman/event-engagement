...
class LotteryController extends Controller
{
    public function index(Event $event, Request $request)
    {
        ...
        return view('moderator.lottery.index', compact('event', 'entries', 'winner', 'totalCount', 'search', 'lotteryExtraKeys'));
    }
    ...
    public function draw(Event $event)
    {
        ...
        return redirect()->route('moderator.lottery.index', $event)
    ...
    public function destroy(Event $event, LotteryEntry $entry)
    {
        $entry->delete();
