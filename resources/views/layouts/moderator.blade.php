...
<head>
    ...
    <title>@yield('title','Dashboard') — Moderator Portal</title>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .sb-logo .wordmark{font-family:'Syne',sans-serif;font-size:18px;font-weight:800;color:var(--mod)}
        .sb-logo .tagline{font-size:10px;letter-spacing:2px;text-transform:uppercase;color:var(--muted);margin-top:2px}
        .sb-event-badge{margin:10px 12px 0;background:rgba(99,102,241,.12);border:1px solid rgba(99,102,241,.25);border-radius:8px;padding:8px 12px}
        .sb-event-badge .ev-label{font-size:9px;letter-spacing:1.5px;text-transform:uppercase;color:var(--mod);font-weight:700}
        .sb-event-badge .ev-name{font-size:13px;font-weight:700;margin-top:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
        ...
        .sb-avatar{width:34px;height:34px;border-radius:50%;object-fit:cover;border:2px solid var(--mod)}
        .sb-user-info .sb-name{font-weight:600;font-size:13px;line-height:1.2}
        .sb-user-info .sb-role{font-size:11px;color:var(--mod);font-weight:600}
        ...
        .stat-value.c-mod{color:var(--mod)}
        ...
        .btn-primary{background:var(--mod);color:#fff}.btn-primary:hover{background:#4f52d8}
        ...
        .btn-outline{background:transparent;border:1px solid var(--border);color:var(--text)}.btn-outline:hover{border-color:var(--mod);color:var(--mod)}
        ...
        .form-control:focus{outline:none;border-color:var(--mod)}
        ...
        .tab.active{color:var(--mod);border-bottom-color:var(--mod)}
        ...
        .progress-fill{height:100%;background:var(--mod);border-radius:4px;transition:width .5s ease}
        ...
        .text-mod{color:var(--mod)}.text-gold{color:var(--gold)}.text-green{color:var(--green)}.text-red{color:var(--red)}
        .font-bold{font-weight:700}.truncate{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
        .w-full{width:100%}.max-w-lg{max-width:640px}
...
<aside class="sidebar" id="sidebar">
    <div class="sb-logo">
        ...
        <div class="tagline">Moderator Portal</div>
    </div>

    @php $event = $event ?? null; @endphp

    @if($event)
    <div class="sb-event-badge">
        <div class="ev-label">Your Event</div>
    ...
    <div class="sb-footer">
        <div class="sb-user">
            ...
            <div class="sb-user-info">
                ...
                <div class="sb-role">Moderator</div>
            </div>
        </div>
    </div>
</aside>
