...
@section('page-title')
    <i data-lucide="help-circle" class="lucide-icon"></i> Quiz to Win
@endsection

@section('topbar-actions')
    <a href="{{ route('admin.quiz.export', $event) }}" class="btn btn-ghost btn-sm"><i data-lucide="download" class="lucide-icon"></i> CSV</a>
    ...
    <div class="card mb-3" style="border-color:rgba(99,232,130,.3);background:rgba(99,232,130,.04)">
        <div class="card-body" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px">
            ...
            <div style="display:flex;gap:8px;flex-wrap:wrap">
                <a href="{{ route('admin.quiz.leaderboard', [$event, $activeRound]) }}" class="btn btn-secondary btn-sm">Leaderboard</a>
                <form method="POST" action="{{ route('admin.quiz.end', $event) }}">
                    @csrf
...
<div class="grid-2" style="gap:16px;align-items:start">
    ...
    <div>
            ...
            @forelse ($questions as $q)
                <div style="border-bottom:1px solid var(--border);padding:14px 18px" id="question-row-{{ $q->id }}">
                    ...
                    <div id="edit-form-{{ $q->id }}" style="display:none;margin-top:12px">
                        <form method="POST" action="{{ route('admin.quiz.questions.update', $q) }}" enctype="multipart/form-data">
                            @csrf @method('PUT')
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.quiz.questions.store', $event) }}" id="addQuestionForm" enctype="multipart/form-data">
                    @csrf
                    @if ($errors->any())
    ...
    <div>
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                @else
                    <form method="POST" action="{{ route('admin.quiz.start', $event) }}" id="startRoundForm">
                        @csrf
                        <div class="form-row">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.quiz.settings', $event) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                            ...
                            @foreach ($rounds as $round)
                                <tr>
                                    ...
                                    <td style="display:flex;gap:6px">
                                        <a href="{{ route('admin.quiz.leaderboard', [$event, $round]) }}" class="btn btn-ghost btn-sm">Results</a>
                                        <form method="POST" action="{{ route('admin.quiz.rounds.reset', $round) }}" onsubmit="return confirm('Reset all answers for this round?')">
                                            @csrf
