...
@section('topbar-actions')
    <a href="{{ route('admin.fanclash.export', $event) }}" class="btn btn-ghost btn-sm">⬇ CSV</a>
...
@if ($activeRound)
    <div class="card mb-3" style="border-color:rgba(239,68,68,.35);background:rgba(239,68,68,.05)">
        <div class="card-body" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px">
            ...
            <form method="POST" action="{{ route('admin.fanclash.end', $event) }}">
                @csrf
...
<div class="grid-2" style="gap:16px;align-items:start">
    ...
    <div>
                ...
                <div style="border-bottom:1px solid var(--border);padding:14px 18px" id="matchup-row-{{ $m->id }}">
                    <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:10px">
                        ...
                        <div style="display:flex;gap:6px;flex-shrink:0">
                            ...
                            <form method="POST" action="{{ route('admin.fanclash.matchups.destroy', $m) }}" onsubmit="return confirm('Delete this matchup?')">
                                @csrf @method('DELETE')
                    ...
                    <div id="matchup-edit-{{ $m->id }}" style="display:none;margin-top:12px">
                        <form method="POST" action="{{ route('admin.fanclash.matchups.update', $m) }}" enctype="multipart/form-data">
                            @csrf @method('PUT')
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.fanclash.matchups.store', $event) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label class="form-label">Category (optional)</label>
    ...
    <div>
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                @else
                    <form method="POST" action="{{ route('admin.fanclash.start', $event) }}" id="fcStartForm">
                        @csrf
                            ...
                            @foreach ($rounds as $round)
                                <tr>
                                    ...
                                    <td style="display:flex;gap:6px">
                                        <form method="POST" action="{{ route('admin.fanclash.rounds.reset', $round) }}" onsubmit="return confirm('Reset this round (clears taps and participants)?')">
                                            @csrf
